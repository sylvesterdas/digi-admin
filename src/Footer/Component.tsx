        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/situations/life" className="text-white/70 hover:text-white text-sm transition-colors">
                  Life Situations
                </Link>
              </li>
              <li>
                <Link href="/situations/business" className="text-white/70 hover:text-white text-sm transition-colors">
                  Business Situations
                </Link>
              </li>
              <li>
                <Link href="/services/popular" className="text-white/70 hover:text-white text-sm transition-colors">
                  Popular Services
                </Link>
              </li>
              <li>
                <Link href="/funding" className="text-white/70 hover:text-white text-sm transition-colors">
                  Funding Programs
                </Link>
              </li>
            </ul>
